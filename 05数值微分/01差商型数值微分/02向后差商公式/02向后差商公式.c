...
double BackwardDifference(struct Point *p, int n, double x){
    double result = 0;
    ...
    double h = p[current_point].x - p[forward_point].x;
    result = (p[current_point].y - p[forward_point].y) / h;
    return result;
}
