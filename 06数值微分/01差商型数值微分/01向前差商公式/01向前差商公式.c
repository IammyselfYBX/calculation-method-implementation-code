...
double ForwardDifference(struct Point *p, int n, double x){
    double result = 0;
    ...
    double h = p[next_point].x - p[current_point].x;
    result = (p[next_point].y - p[current_point].y) / h;
    return result;
}
